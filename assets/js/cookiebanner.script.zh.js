...
var config = {
	...
	"necessaryCookieTypeDesc": "这些 cookie 是网站运行所必需的，并且无法在我们的系统中关闭。",
	"cookieTypes": [{
		"type": "偏好",
		"value": "preferences",
		"description": "偏好 cookie 使网站能够记住改变网站行为或外观的信息，例如您的首选语言或您所在的地区。"
	}, {
		"type": "营销",
		"value": "marketing",
		"description": "营销 cookie 用于跨网站追踪访客。其目的是向个人用户展示与其相关且具有吸引力的广告，从而为发布商和第三方广告商带来更多价值。"
	}, {
		"type": "分析",
		"value": "analytics",
		"description": "分析性 Cookie 使我们能够统计访问量和流量来源，从而衡量并改进网站的性能。它们帮助我们了解哪些页面最受欢迎和最不受欢迎，并了解访客在网站上的浏览行为。"
	}]
};
...
var injectScripts = function() {
		"undefined" != typeof headerScripts && (cookieBanner.isPreferenceAccepted("analytics") === !0 && appendScriptInHead("analytics"), cookieBanner.isPreferenceAccepted("marketing") === !0 && appendScriptInHead("marketing"), cookieBanner.isPreferenceAccepted("preferences") === !0 && appendScriptInHead("preferences"))
	}
	...
	! function(e) {
		...
		e.fn.cookieBanner = function() {
			...
			if (c) injectScripts()
				...
				setTimeout(function() {
					e("body").append(p), e("#cookieBanner").hide().fadeIn("slow"), config.showSettingsBtn || e("#cookieSettings").hide(), config.showDeclineBtn || e("#cookieReject").hide(), config.showCloseIcon || e("#closeIcon").hide()
				}, config.delay), e("body").on("click", "#cookieAccept", function() {
					...
					e('input[name="gdprPrefItem"]:not(:disabled)').attr("data-compulsory", "off").prop("checked", !0), e("#cookieTypes").toggle("fast", function() {
						e("#cookieSettings").prop("disabled", !1)
					})
				}), e("body").on("click", "#closeIcon", function() {
					e("#cookieBanner").remove()
				}), e("body").on("click", "#cookieReject", function() {
					r(!1, config.expires), t("cookieConsentPrefs", "", {
						expires: o(-365),
						path: "/"
					})
				})
		...
		var i = function(e) {
			...
			t = function(e, c) {
				...
				document.cookie = "".concat(e, "=").concat(c).concat(Object.keys(i).reduce(function(e, c) {
					return e + ";".concat(c.replace(/([A-Z])/g, function(e) {
