...
const footerData = {
  ...
  legalInfo: {
    ...
    links: [
      { text: 'Cookie 政策', url: 'https://www.medlkai.com/zh/cookie-policy.html' },
      { text: '隐私政策', url: 'https://www.medlkai.com/zh/privacy-policy.html' },
      { text: '使用条款', url: 'https://www.medlkai.com/zh/terms-of-use.html' },
      { text: '网站地图', url: 'https://www.medlkai.com/sitemap.xml', target: '_blank' }
    ],
    lastUpdate: '2025年09月15日',
    ...
    <div class="container small py-4 border-top border-dark">
      <div class="row align-items-center text-center">
        ...
        <div class="col-12 col-md-4 mb-3 mb-md-0">
          ${legalLinksHtml}
          <div class="mt-2">最后更新：${data.legalInfo.lastUpdate}</div>
        </div>
